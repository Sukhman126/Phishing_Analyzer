...
*[span_0](start_span)Submitted To:* Dipika Sharma (Assistant Professor)[span_0](end_span)  
*[span_1](start_span)Institution:* Sardar Beant Singh State University, Gurdaspur[span_1](end_span)
...
* *[span_2](start_span)IP Address Detection:* Detects if an IP address is used instead of a domain name[span_2](end_span).
* *[span_3](start_span)Keyword Detection:* Scans for suspicious words like "login", "bank", and "update"[span_3](end_span).
