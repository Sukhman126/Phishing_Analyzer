...
2. Run the following commands in the terminal to set up and run the project:
...
4. Enter a website URL and click Analyze URL to check whether the URL is safe or potentially suspicious.
